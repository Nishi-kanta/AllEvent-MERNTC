...
const Setting = () => {
  return (
    <div className="w-full h-full flex flex-col">
      <section className="text-black flex flex-col justify-start items-start w-full h-screen overflow-y-auto">
        ...
        <h1 className="text-4xl font-bold">Welcome to Our Product</h1>
        <p className="text-lg mt-4">A short and compelling tagline goes here.</p>
        <div className="flex w-full justify-end px-8 mt-auto mb-8">
